...
const corsOptions = {
    origin: ['http://localhost:5500', 'http://127.0.0.1', 'https://auth-user-api.onrender.com', 'https://auth-user-api.onrender.com/api/forms/auth', 'https://auth-user-api.onrender.com/api/forms/'],
